class Sunny
  ...
  BOT.command :amaranthus do |event|
    break unless event.user.id.player?
  ...
  BOT.command :sweet_potato do |event|
    break unless event.user.id.player?
  ...
  BOT.command :bell_pepper do |event|
    break unless event.user.id.player?
  ...
  BOT.command :bellpeppers do |event|
    break unless event.user.id.player?
  ...
  BOT.command :bellpepper do |event|
    break unless event.user.id.player?
