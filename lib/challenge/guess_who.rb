class Sunny
  ...
  BOT.command :guess_who do |event|
    ...
    BOT.send_file(BOT.channel(1378044547287879731), file, filename: 'mystery_animal.ogg')
  end
  ...
  BOT.command :dog do |event|
    ...
    BOT.send_file(BOT.channel(1378044547287879731), file, filename: 'mystery_animal.wav')
  end
  ...
  BOT.command :cow do |event|
    ...
    BOT.send_file(BOT.channel(1378044547287879731), file, filename: 'mystery_animal.mp3')
  end
